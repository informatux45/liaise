'Standard 35' TrueType fonts
----------------------------

These fonts are converted from fonts normally distributed as part of the
Ghostscript package in the file 'ghostscript-fonts-std-4.03.tar.gz'. The
source fonts are individually marked with the following Copyright information:
...
The following information is extracted from 'Fontmap' - a component of
the Ghostscript distribution.  'Fontmap' is Copyright (C) 1996 Aladdin
...
The following notice applies for each font:
...
The fonts were converted from type 1 to TrueType format using
