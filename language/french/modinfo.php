...
define("_MI_LIAISE_DESC","G&#233;n&#233;rateur de formulaires");

// admin/menu.php
define("_MI_LIAISE_ADMENU1","Accueil");
define("_MI_LIAISE_ADMENU2","Formulaires");
define("_MI_LIAISE_ADMENU3","El&eacute;ments de formulaire");
define("_MI_LIAISE_ADMENU4","Tous les messages");
define("_MI_LIAISE_ADMENU5","A propos");
define("_MI_LIAISE_ADMENU6","Synth&#232;se");
...
define("_MI_LIAISE_TMPL_HEADER_DESC",   "Header Fichier Template");
...
######### version 2.0 #########
define("_MI_LIAISE_BREADCRUMB", "Fil d'ariane (Chemin)");
define("_MI_LIAISE_BREADCRUMB_DESC", "Afficher le fil d'ariane sur les pages du module");
