...
PRIMARY KEY  (`form_id`),  KEY `form_order` (`form_order`));
...
PRIMARY KEY  (`ele_id`),  KEY `ele_display` (`ele_display`),  KEY `ele_order` (`ele_order`));

INSERT INTO `xliaise_formelements` VALUES (1, 1, 'checkbox', 'What are your hobbies?', 11, 1, 'a:7:{s:13:"I\'m a dreary.";i:1;s:35:"Searching adult contents on the net";i:0;s:66:"Arguing with people about those stupid things on discussion boards";i:0;s:33:"Searching software serial numbers";i:0;s:6:"Speech";i:0;s:34:"Making weapons of mass destruction";i:0;s:10:"{OTHER|30}";i:0;}', 1);
...
INSERT INTO `xliaise_formelements` VALUES (12, 1, 'select', 'Why did you buy a computer?', 8, 1, 'a:3:{i:0;i:10;i:1;i:1;i:2;a:6:{s:25:"My room is too big for me";i:1;s:25:"I don\'t have a girlfriend";i:0;s:18:"My wife is a biddy";i:0;s:17:"I like spam mails";i:0;s:29:"That makes me look more smart";i:0;s:13:"I just forgot";i:0;}}', 1);
...
INSERT INTO `xliaise_formelements` VALUES (15, 1, 'html', '', 10, 0, 'a:3:{i:0;s:316:"I have no idea what should be placed here. Maybe a chapter from the holy bible? [url=http://www.randomwebsearch.com/cgi-bin/randomWebSearch.pl?mode=generate]Click here[/url] if you have too much time to waste, or [url=http://www.landoverbaptist.org/news0104/ps2.html]get a free PlayStation 2[/url] if you are boring.";i:1;i:10;i:2;i:50;}', 1);
