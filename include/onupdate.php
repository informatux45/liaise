 ...
 */
function xoops_module_pre_update_liaise(XoopsModule $module)
{
...
function xoops_module_update_liaise(XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    ...
    /** @var Liaise\Helper $helper */
    /** @var Liaise\Utility $utility */
    /** @var Liaise\Configurator $configurator */
    $helper  = Liaise\Helper::getInstance();
    $utility = new Liaise\Utility();
    $configurator = new Liaise\Configurator();

    if ($previousVersion < 240) {

        //rename column EXAMPLE
        $tables     = new Tables();
        $table      = 'liaisex_categories';
        $column     = 'ordre';
        $newName    = 'order';
